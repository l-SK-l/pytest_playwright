...
class DashboardPage:
    ...
    def check_widget_vpn_available(self) -> None:
    ...
    def check_widget_Network_ifaces_available(self) -> None:
    ...
    def check_widget_Network_security_available(self) -> None:
    ...
    def del_network_security_dashboard(self) -> None:
        self.page.locator("div").filter(has_text=re.compile(
            r"^Network security log$")).get_by_role("button").first.click()
